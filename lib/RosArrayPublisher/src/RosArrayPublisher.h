...
template<typename ARRAY_TYPE> class RosArrayPublisher{
    ...
    RosArrayPublisher(auto& nh,const char *topic_name,int array_size);
...
RosArrayPublisher<ARRAY_TYPE>::RosArrayPublisher(auto& nh,const char *topic_name,int array_size):
